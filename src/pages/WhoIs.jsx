    ...
    return (
        <div>
            ...
            <Figure>
                ...
                />
                <body className='body_whois'>
                    <div className='div1'>
                        <p style={{ fontSize: "30px", color: "black", marginBottom: "20px", fontStyle: "italic" }}> Hello Visitor, I am Hakan ÖZDABAK</p></div></body>
                ...
                <p style={{ fontSize: "30px", color: "black", marginBottom: "20px", fontStyle: "italic", textDecorationLine: "underline" }}> Work Experience</p>
                <Row>
                ...
                <hr width="100%" color="chocolate" size="10" />
                <p style={{ fontSize: "30px", color: "black", marginBottom: "20px", fontStyle: "italic", textDecorationLine: "underline" }}> Abilities</p>
                ...
                <hr width="100%" color="chocolate" size="10" />
                <p style={{ fontSize: "30px", color: "black", marginBottom: "20px", fontStyle: "italic", textDecorationLine: "underline" }}> Certificates</p>
